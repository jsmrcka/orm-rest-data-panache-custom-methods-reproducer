# orm-rest-data-panache-custom-methods-reproducer
...
You can then execute your native executable with: `./target/orm-rest-data-panache-custom-methods-reproducer-1.0.0-SNAPSHOT-runner`
